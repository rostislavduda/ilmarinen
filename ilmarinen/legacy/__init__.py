...
_SYMBOL_MODULE = {
    "build_model": "networks",
    "MODEL_REGISTRY": "networks",
    "PlainMLP": "networks",
    "ResNetMLP": "networks",
    "build_rnn": "recurrent",
    "RNN_REGISTRY": "recurrent",
    "PlainRNN": "recurrent",
    "train_and_eval": "training",
    "train_and_eval_rnn": "training",
    "gradient_norms_at_init": "training",
    "to_tensor": "training",
    "build_supergraph": "supergraph",
    "SUPERGRAPH_REGISTRY": "supergraph",
    "SuperGraphRNN": "supergraph",
    "SuperCell": "supergraph",
    "DiscreteRNN": "supergraph",
    "discretize": "supergraph",
    ...
    "build_spatial_supergraph": "spatial_supergraph",
    "SpatialSuperGraph": "spatial_supergraph",
    "validate_width_sparsity": "pipelines",
    "validate_criticality": "pipelines",
    "validate_priced_depth": "pipelines",
    "validate_sequential_baseline": "pipelines",

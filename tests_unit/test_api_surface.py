...
EXPECTED_EXPORTS = {
    "ApproxEquivariantModel", "FashionMNIST", "MODEL_REGISTRY", "MeanFieldTheory", "AllData",
    "AllGraph", "RNN_REGISTRY", "ScalableEquivariantMLP", "VariableWidthNet", "area_price_path",
    "best_device", "build_latent_equivariant_contract", "build_model", "build_rnn",
    "build_scalable_equivariant_mlp", "certificate_lambda_scale", "column_generation_solve",
    "continuous_invariant_features", "contract_evidence", "critical_betas", "critical_exponent",
    "discover_and_reduce", "effective_dimension", "empirical_exponent", "estimate_llc", "explain",
    "feature_selection_path", "fit_feature_attribution", "fit_variable_width_area", "format_report",
    "free_energy", "gib_spectrum", "greedy_insertion", "ib_effective_dimension", "ib_rg_flow",
    "layer_rg_flow", "measure_depth_curve", "measure_mode_curve", "mps_available", "price_relaxation",
    "reduce_redundancy", "resolve_device", "route_by_structure", "score_to_nll", "select_depth",
    "select_modes", "select_relaxation", "significant_elbow", "spectral_code_length",
...
_DEPRECATED = ["build_model", "MODEL_REGISTRY", "build_rnn", "RNN_REGISTRY",
